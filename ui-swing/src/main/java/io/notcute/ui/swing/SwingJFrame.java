...
public class SwingJFrame extends JFrame implements SwingContainer, ComponentListener, WindowListener, WindowFocusListener,
    ...
    protected static class Holder implements Container.Holder {
        ...
        private final SwingJFrame container;
        public Holder(SwingJFrame container) {
    ...
    private final SwingJPanel g2DContext;
    private final SwingJFrame.Holder holder;

    public SwingJFrame() {
        this("");
    }

    public SwingJFrame(GraphicsConfiguration gc) {
        this("", gc);
    }

    public SwingJFrame(String title) {
        this(title, null);
    }

    public SwingJFrame(String title, GraphicsConfiguration gc) {
        super(title, gc);
        setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
        setLocationByPlatform(true);
        enableInputMethods(false);
        g2DContext = new SwingJPanel();
        add(g2DContext);
