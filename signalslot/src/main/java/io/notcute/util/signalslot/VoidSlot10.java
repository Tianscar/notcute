...
/**
 * A void slot with 10 generic arguments.
 *
 ...
 */
@FunctionalInterface
public interface VoidSlot10<A, B, C, D, E, F, G, H, I, J> extends FunctionalVoidSlot {

	void accept(A a, B b, C c, D d, E e, F f, G g, H h, I i, J j);

	default VoidSlot10<A, B, C, D, E, F, G, H, I, J> andThen(
			VoidSlot10<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J> after) {
