...
/**
 * A slot with 10 generic arguments.
 *
 ...
 */
@FunctionalInterface
public interface Slot10<A, B, C, D, E, F, G, H, I, J, R> extends FunctionalSlot<R> {

    R accept(A a, B b, C c, D d, E e, F f, G g, H h, I i, J j);
