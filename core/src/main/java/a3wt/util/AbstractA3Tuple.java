 ...
 *
 */
public abstract class AbstractA3Tuple implements A3Tuple, Serializable {
    ...
    protected AbstractA3Tuple(final Object... values) {
        super();
    ...
    public final boolean equals(final Object obj) {
        ...
        final AbstractA3Tuple other = (AbstractA3Tuple) obj;
        return this.valueList.equals(other.valueList);
    }
    
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @Override
    public int compareTo(final A3Tuple o) {
        final int tLen = this.valueArray.length;
        final Object[] oValues = o instanceof AbstractA3Tuple ? ((AbstractA3Tuple)o).valueArray : o.toArray();
