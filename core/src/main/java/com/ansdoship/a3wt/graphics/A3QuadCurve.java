...
public interface A3QuadCurve extends A3Shape<A3QuadCurve> {
    ...
    void set(final float startX, final float startY, final float ctrlX, final float ctrlY, final float endX, final float endY);
    void set(final A3Point startPos, final A3Point ctrlPos, final A3Point endPos);
