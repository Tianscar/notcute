...
public class AnimatedGifEncoder {
	  ...
	  protected void getImagePixels() {
	    ...
	    if ((w != width) || (h != height) || (image.getConfig() != Bitmap.Config.RGB_565)) {
			throw new IllegalStateException("Invalid image! The image should be the same size of the specified size of each frame, " +
					"and the config should be Bitmap.Config.RGB_565.");
			/*
