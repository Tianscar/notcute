...
public class AWTContainer extends Frame implements Container, ComponentListener, WindowListener, WindowFocusListener,
    ...
    private final AWTG2DContext g2DContext;
    private final AWTContainer.Holder holder;

    public AWTContainer() {
        this("");
    }

    public AWTContainer(GraphicsConfiguration gc) {
        this("", gc);
    }

    public AWTContainer(String title) {
        this(title, null);
    }

    public AWTContainer(String title, GraphicsConfiguration gc) {
        super(title, gc);
        setLocationByPlatform(true);
        enableInputMethods(false);
        g2DContext = new AWTG2DContext();
        add(g2DContext);
