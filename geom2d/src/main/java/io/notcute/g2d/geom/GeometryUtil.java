...
final class GeometryUtil {
     ...
     * 			otherwise 0
     */
    public static int intersectLines(float x1, float y1, float x2, float y2,
                                     float x3, float y3, float x4, float y4,
                                     float[] point) {
        float A1 = -(y2 - y1);
        float B1 = (x2 - x1);
     ...
     */
    public static int intersectQuads(float x1, float y1, float x2, float y2,
                                     float x3, float y3, float qx1, float qy1,
                                     float qx2, float qy2, float qx3, float qy3,
                                     float[] params) {
     ...
     */
    public static int intersectCubics(float x1, float y1, float x2, float y2,
                                      float x3, float y3, float x4, float y4,
                                      float cx1, float cy1, float cx2, float cy2,
                                      float cx3, float cy3, float cx4, float cy4,
                                      float[] params) {
    ...
    public static float cubic(float t, float x1, float x2, float x3, float x4) {
        return x1 * (1.0f - t) * (1.0f - t) * (1.0f - t) +
                3.0f * x2 * (1.0f - t) * (1.0f - t) * t +
                3.0f * x3 * (1.0f - t) * t * t +
                x4 * t * t * t;
    }
    ...
    private static void cubicNewton(float[] xCoefs1, float[] yCoefs1, float[] xCoefs2,
                                    float[] yCoefs2, float[] params) {
    	float t = 0.0f, s = 0.0f;
    	float t1 = params[0];
        float s1 = params[1];
    	float d, dt, ds;
    ...
    private static void quadNewton(float[] xCoefs1, float[] yCoefs1, float[] xCoefs2,
                                   float[] yCoefs2, float[] params) {
    	float t = 0.0f, s = 0.0f;
    	float t1 = params[0];
    	float s1 = params[1];
