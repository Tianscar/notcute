...
final class CurveCrossingHelper {

    private final float[][] coords;
    private final int[][] rules;
    private final int[] sizes;
    private final int[] rulesSizes;
    private final int[][] offsets;
    private final List<IntersectPoint> isectPoints = new ArrayList<>();
    ...
    public IntersectPoint[] findCrossing() {
        ...
        for (int i = 0; i < rulesSizes[0]; i++) {
            ...
            for (int j = 0; j < rulesSizes[1]; j++) {
                ...
                } else if (rule1 == QUAD_TO &&
                        (rule2 == LINE_TO || rule2 == CLOSE)) {
                    ipCount = GeometryUtil.intersectLineAndQuad(
